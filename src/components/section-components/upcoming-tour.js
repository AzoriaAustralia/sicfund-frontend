		        ...
		        <div className="upcomming-card-slider upcomming-card-slider-2 tp-common-slider-style">
		          <div className="single-upconing-card">
		            ...
		            <div className="details">
		              <h3 className="title"><Link href="/tour-details">Rome</Link></h3>
		          ...
		          <div className="single-upconing-card">
		            ...
		            <div className="details">
		              <h3 className="title"><Link href="/tour-details">Great Barrier</Link></h3>
		          ...
		          <div className="single-upconing-card">
		            ...
		            <div className="details">
		              <h3 className="title"><Link href="/tour-details">Barrier Reef</Link></h3>
		          ...
		          <div className="single-upconing-card">
		            ...
		            <div className="details">
		              <h3 className="title"><Link href="/tour-details">Machu Picchu</Link></h3>
		              <p><i className="fa fa-map-marker" /> Peru</p>
		              <div className="tp-review-meta">
		                <i className="ic-yellow fa fa-star" />
		                <i className="ic-yellow fa fa-star" />
