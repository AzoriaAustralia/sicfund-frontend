                      ...
                      <div className="col-lg-4 col-sm-6">
                        <div className="single-destinations-list style-two">
                          ...
                          <div className="details">
                            ...
                            <h4 className="title"><Link href="/tour-details">Cox's bazar Sea Beach</Link></h4>
                      ...
                      <div className="col-lg-4 col-sm-6">
                        <div className="single-destinations-list style-two">
                          ...
                          <div className="details">
                            ...
                            <h4 className="title"><Link href="/tour-details">Amazon Africa</Link></h4>
                      ...
                      <div className="col-lg-4 col-sm-6">
                        <div className="single-destinations-list style-two">
                          ...
                          <div className="details">
                            ...
                            <h4 className="title"><Link href="/tour-details">Thailand beach</Link></h4>
                      ...
                      <div className="col-lg-4 col-sm-6">
                        <div className="single-destinations-list style-two">
                          ...
                          <div className="details">
                            ...
                            <h4 className="title"><Link href="/tour-details">France eiffel tower</Link></h4>
