            ...
            <div className="row">
               <div className="col-lg-6">
                  <div className="single-destinations-list style-four">
                     <div className="blur-thumb"
                          style={{ backgroundImage: "url(" + publicUrl + "assets/img/destination-list/16.png)" }} />
                     <div className="details">
                        ...
                        <h4 className="title"><Link href="/tour-details">Dubai City</Link></h4>
                        <p className="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
               ...
               <div className="col-lg-6">
                  <div className="single-destinations-list style-four">
                     <div className="blur-thumb"
                          style={{ backgroundImage: "url(" + publicUrl + "assets/img/destination-list/11.png)" }} />
                     <div className="details">
                        <div className="tp-review-meta">
                           <i className="ic-yellow fa fa-star" />
                           <i className="ic-yellow fa fa-star" />
                        ...
                        <h4 className="title"><Link href="/tour-details">Eiffel Tower</Link></h4>
                        <p className="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                           eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                        <div className="list-price-meta">
                           <ul className="tp-list-meta d-inline-block">
               ...
               <div className="col-lg-6">
                  <div className="single-destinations-list style-four">
                     <div className="blur-thumb"
                          style={{ backgroundImage: "url(" + publicUrl + "assets/img/destination-list/12.png)" }} />
                     <div className="details">
                        <div className="tp-review-meta">
                           <i className="ic-yellow fa fa-star" />
                           <i className="ic-yellow fa fa-star" />
               ...
               <div className="col-lg-6">
                  <div className="single-destinations-list style-four">
                     <div className="blur-thumb"
                          style={{ backgroundImage: "url(" + publicUrl + "assets/img/destination-list/5.png)" }} />
                     <div className="details">
                        <div className="tp-review-meta">
                           <i className="ic-yellow fa fa-star" />
                           <i className="ic-yellow fa fa-star" />
               ...
               <div className="col-lg-6">
                  <div className="single-destinations-list style-four">
                     <div className="blur-thumb"
                          style={{ backgroundImage: "url(" + publicUrl + "assets/img/destination-list/7.png)" }} />
                     <div className="details">
                        <div className="tp-review-meta">
                           <i className="ic-yellow fa fa-star" />
                           <i className="ic-yellow fa fa-star" />
               ...
               <div className="col-lg-6">
                  <div className="single-destinations-list style-four">
                     <div className="blur-thumb"
                          style={{ backgroundImage: "url(" + publicUrl + "assets/img/destination-list/9.png)" }} />
                     <div className="details">
                        <div className="tp-review-meta">
                           <i className="ic-yellow fa fa-star" />
                           <i className="ic-yellow fa fa-star" />
                        ...
                        <h4 className="title"><Link href="/tour-details">Hurawalhi Island</Link></h4>
                        <p className="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                           eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                        <div className="list-price-meta">
                           <ul className="tp-list-meta d-inline-block">
