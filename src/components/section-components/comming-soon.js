...
class CommingSoon extends Component {
   ...
   render() {
      ...
      return <div className="comming-soon-page"
                  style={{ backgroundImage: "url(" + publicUrl + "assets/img/bg/12.png)" }}>
               ...
               <div className="col-12 comming-soon-info-wrap text-center">
                  <div className="comming-soon-info m-auto">
                     ...
                     <div className="btn-wrapper">
                        <Link className="btn btn-transparent" href="/contact">You Are Contact With Us</Link>
                     </div>
                     <ul className="social-icon">
                        <li>
                           <a className="facebook" href="https://www.facebook.com/codingeek.net/" target="_blank"><i
                              className="fa fa-facebook  " /></a>
                        </li>
                        <li>
                           <a className="twitter" href="https://twitter.com/codingeeknet" target="_blank"><i
                              className="fa fa-twitter  " /></a>
                        </li>
                        <li>
                           <a className="pinterest" href="https://www.instagram.com/codingeeknet/" target="_blank"><i
                              className="fa fa-instagram" /></a>
                        </li>
                        <li>
                           <a className="linkedin" href="https://www.linkedin.com/company/codingeek/about/"
