                     ...
                     <div className="tp-gallery-item col-lg-8 col-md-6 col-12 mb-10">
                        <div className="tp-gallery-item-img">
                           ...
                           <div className="details">
                              <h3>Africa</h3>
                              <p>Etiam convallis elementum sapien, aliquam turpis aliquam vitae Praese
                                 sollicitudin <br /> felis vel mi facilisis posuere. Nulla ultrices facilisis</p>
                              <Link className="btn-read-more" href="/destination-details"><span>Explore<i
