                  ...
                  <div className="row">
                     <div className="col-xl-8">
                        <div className="section-title mb-0">
                           ...
                           <p>Aenean non accumsan ante. Duis et risus accumsan sem tempus porta nec sit amet est. Sed ut
                              euismod quam. Suspendisse potenti. Aliquam fringilla</p>
                        </div>
                     </div>
                  </div>
                  <div className="row">
                     <div className="col-md-5">
                        <ul className="nav nav-tabs tp-tabs">
                           ...
                           <li className="nav-item">
                              <a className="nav-link" data-toggle="tab" href="#tabs_5">I have a disability – can I join
                                 an trip?</a>
                           </li>
                           <li className="nav-item">
                              <a className="nav-link" data-toggle="tab" href="#tabs_6">Are Intrepid trips suitable for
                                 LGBTQI?</a>
                           </li>
                           <li className="nav-item">
                     ...
                     <div className="col-md-7">
                        <div className="tab-content faq-tab-content"
                             style={{ backgroundImage: "url(" + publicUrl + "assets/img/others/12.png)" }}>
                           <div className="tab-pane fade show active" id="tabs_1">
                              <div className="faq-details">
                                 <h6>01 I have special dietary requirements – will they be catered for?</h6>
                                 <p>We will try our very hardest to accommodate all dietary requirements but in some
                                    out-of-the-way places it can be very difficult to guarantee. We will let you know if
                                    there are places on your itinerary where this is the case. Please let us know at the
                                    time of booking of any food requirements or allergies and we’ll pass the
                                    information</p>
                                 <h6>What will the food be like on my trip?</h6>
                                 <p className="mb-0">Food is one of the most exciting parts of travel. There may be some
                                    familiar fare but often you’ll be confronted with the new, interesting and downright
                                    weird of the culinary world but we like to think of it as an adventure for all the
                                    senses. In addition to this, our flexible itineraries often</p>
                              </div>
                           </div>
