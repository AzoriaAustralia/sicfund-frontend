            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="section-title text-center">
                     <h2 className="title wow animated fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.1s">Best
                        Packages For You</h2>
                     <p className="wow animated fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.2s">Vivamus eget
                        aliquam dui. Integer eu arcu vel arcu suscipit ultrices quis non mauris. Aenean scelerisque, sem
                        eu dictum commodo, velit nisi</p>
                  </div>
               </div>
            </div>
            <div className="row">
               <div className="col-xl-3 col-sm-6">
                  <div className="single-package-card wow animated fadeInUp" data-wow-duration="0.4s"
                       data-wow-delay="0.1s">
                     <div className="thumb">
               ...
               <div className="col-xl-3 col-sm-6">
                  <div className="single-package-card wow animated fadeInUp" data-wow-duration="0.7s"
                       data-wow-delay="0.2s">
                     <div className="thumb">
               ...
               <div className="col-xl-3 col-sm-6">
                  <div className="single-package-card wow animated fadeInUp" data-wow-duration="1.0s"
                       data-wow-delay="0.3s">
                     <div className="thumb">
               ...
               <div className="col-xl-3 col-sm-6">
                  <div className="single-package-card wow animated fadeInUp" data-wow-duration="1.3s"
                       data-wow-delay="0.4s">
                     <div className="thumb">
