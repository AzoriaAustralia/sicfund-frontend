            ...
            <div className="row justify-content-center">
               <div className="col-lg-7">
                  <div className="section-title text-center">
                     ...
                     <p>Curabitur vulputate arcu odio, ac facilisis diam accumsan ut. Ut imperdiet et leo in vulputate.
                        Sed eleifend lacus eu posuere viverra. Vestibulum id turpis lectus. Donec rhoncus quis elit</p>
                  </div>
               </div>
            </div>
            {/* Gallery area start */}
                  ...
                  <div className="gallery-filter-area row">
                     ...
                     <div className="tp-gallery-item col-md-4 col-12 mb-10">
                        <div className="tp-gallery-item-img">
                           <a className="popup-thumb" href={publicUrl + "assets/img/gallery/1.png"}
                     ...
                     <div className="tp-gallery-item col-md-4 col-12">
                        <div className="tp-gallery-item-img">
                           <a className="popup-thumb" href={publicUrl + "assets/img/gallery/2.png"}
                              data-effect="mfp-zoom-in">
                     ...
                     <div className="tp-gallery-item col-md-4 col-12">
                        <div className="tp-gallery-item-img">
                           <a className="popup-thumb" href={publicUrl + "assets/img/gallery/3.png"}
                              data-effect="mfp-zoom-in">
                     ...
                     <div className="tp-gallery-item col-md-4 col-12">
                        <div className="tp-gallery-item-img">
                           <a className="popup-thumb" href={publicUrl + "assets/img/gallery/4.png"}
                              data-effect="mfp-zoom-in">
                     ...
                     <div className="tp-gallery-item col-md-7 col-12">
                        <div className="tp-gallery-item-img">
                           <a className="popup-thumb" href={publicUrl + "assets/img/gallery/6.png"}
                              data-effect="mfp-zoom-in">
                     ...
                     <div className="tp-gallery-item col-md-5 col-12">
                        <div className="tp-gallery-item-img">
                           <a className="popup-thumb" href={publicUrl + "assets/img/gallery/7.png"}
                              data-effect="mfp-zoom-in">
