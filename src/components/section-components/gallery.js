         ...
         <div className="container">
            <div className="row">
               <div className="col-lg-6">
                  <div className="single-gallery-area bg-gray">
                     <div className="gallery-title">
                        ...
                        <h4><Link href="/gallery-details">Beautiful Beach of Greece</Link></h4>
                     </div>
               ...
               <div className="col-lg-6">
                  <div className="single-gallery-area bg-gray">
                     <div className="gallery-title">
                        <p className="location"><img src={publicUrl + "assets/img/icons/1.png"} alt="img" />Madagascar
                        </p>
                        <h4><Link href="/gallery-details">Underwater world</Link></h4>
                     </div>
                     <div className="gallery-slider">
                        <div className="thumb">
               ...
               <div className="col-lg-6">
                  <div className="single-gallery-area bg-gray">
                     <div className="gallery-title">
                        <p className="location"><img src={publicUrl + "assets/img/icons/1.png"} alt="img" />Arizona,
                           United States</p>
                        <h4><Link href="/gallery-details">Grand Canyon</Link></h4>
                     </div>
                     <div className="gallery-slider">
                        <div className="thumb">
